...
public class ListTest {
    public static void main(String[] args) {
        ...
        allEvents.addAll(macOSEvents);
        allEvents.addAll(javaEvents);
        ...
        for (String row : javaEventRows) {
            allEvents.add(ListTest.makeEvent(row));
        }
    ...
    private static Event makeEvent(String dateString, String description, String categoryString) {
        return ListTest.makeEvent(
            LocalDate.parse(dateString),
            description,
            Category.parse(categoryString));
    }

    private static Event makeEvent(LocalDate date, String description, Category category) {
        return new Event(date, description, category);
    }

    private static Event makeEvent(String row) {
