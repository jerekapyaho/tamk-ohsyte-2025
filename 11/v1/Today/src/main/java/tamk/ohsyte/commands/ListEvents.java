...
import tamk.ohsyte.filters.IdentityFilter;
...
public class ListEvents implements Runnable {
    ...
    public void run() {
        ...
        EventFilter filter = new IdentityFilter();  // default to accepting all
        ...
        List<Event> filteredEvents = manager.getEvents(filter);
